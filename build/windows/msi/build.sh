...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  PRODUCT_NAME="genRTL - Insiders"
  PRODUCT_CODE="genRTLInsiders"
...
if [[ -z "${1}" ]]; then
	OUTPUT_BASE_FILENAME="genRTL-${VSCODE_ARCH}-${RELEASE_VERSION}"
else
	OUTPUT_BASE_FILENAME="genRTL-${VSCODE_ARCH}-${1}-${RELEASE_VERSION}"
fi
