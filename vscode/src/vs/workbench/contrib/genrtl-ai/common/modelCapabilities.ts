...
import { FeatureName, ModelSelectionOptions, OverridesOfModel, ProviderName } from './genrtlSettingsTypes.js';
...
export type genRTLStaticModelInfo = { // not stateful
	// genRTL uses the information below to know how to handle each model.
...
type genRTLStaticProviderInfo = { // doesn't change (not stateful)
...
const defaultModelOptions = {
	...
	supportsFIM: false,
	reasoningCapabilities: false,
} as const satisfies genRTLStaticModelInfo
...
const extensiveModelOptionsFallback: genRTLStaticProviderInfo['modelOptionsFallback'] = (modelName, fallbackKnownValues) => {
...
} as const satisfies { [s: string]: genRTLStaticModelInfo }

const anthropicSettings: genRTLStaticProviderInfo = {
...
const openAISettings: genRTLStaticProviderInfo = {
...
const xAISettings: genRTLStaticProviderInfo = {
...
const geminiSettings: genRTLStaticProviderInfo = {
...
const deepseekSettings: genRTLStaticProviderInfo = {
...
const mistralSettings: genRTLStaticProviderInfo = {
...
const groqSettings: genRTLStaticProviderInfo = {
...
} as const satisfies Record<string, genRTLStaticModelInfo>
const googleVertexSettings: genRTLStaticProviderInfo = {
...
const microsoftAzureSettings: genRTLStaticProviderInfo = {
...
const awsBedrockSettings: genRTLStaticProviderInfo = {
...
const vLLMSettings: genRTLStaticProviderInfo = {
...
const lmStudioSettings: genRTLStaticProviderInfo = {
...
const ollamaSettings: genRTLStaticProviderInfo = {
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
...
const openaiCompatible: genRTLStaticProviderInfo = {
...
const liteLLMSettings: genRTLStaticProviderInfo = { // https://docs.litellm.ai/docs/reasoning_content
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
	modelOptions: {},
	providerReasoningIOSettings: {
		input: { includeInPayload: openAICompatIncludeInPayloadReasoning },
...
const openRouterSettings: genRTLStaticProviderInfo = {
...
const modelSettingsOfProvider: { [providerName in ProviderName]: genRTLStaticProviderInfo } = {
