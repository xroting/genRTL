...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/genrtl-ai/common/genrtlSettingsTypes.js'
import { DisposableStore, IDisposable } from '../../../../../../../base/common/lifecycle.js'
import { genrtlSettingsState } from '../../../../../../../workbench/contrib/genrtl-ai/common/genrtlSettingsService.js'
import { ColorScheme } from '../../../../../../../platform/theme/common/theme.js'
import { RefreshModelStateOfProvider } from '../../../../../../../workbench/contrib/genrtl-ai/common/refreshModelService.js'
...
import { IRefreshModelService } from '../../../../../../../workbench/contrib/genrtl-ai/common/refreshModelService.js';
import { IgenrtlSettingsService } from '../../../../../../../workbench/contrib/genrtl-ai/common/genrtlSettingsService.js';
import { IExtensionTransferService } from '../../../../../../../workbench/contrib/genrtl-ai/browser/extensionTransferService.js'
...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	const stateServices = {
		...
		settingsStateService: accessor.get(IgenrtlSettingsService),
		refreshModelService: accessor.get(IRefreshModelService),
		themeService: accessor.get(IThemeService),
		editCodeService: accessor.get(IEditCodeService),
		genrtlCommandBarService: accessor.get(IgenrtlCommandBarService),
		modelService: accessor.get(IModelService),
		mcpService: accessor.get(IMCPService),
	}

	const { settingsStateService, chatThreadsStateService, refreshModelService, themeService, editCodeService, genrtlCommandBarService, modelService, mcpService } = stateServices
	...
	disposables.push(
		genrtlCommandBarService.onDidChangeState(({ uri }) => {
			commandBarURIStateListeners.forEach(l => l(uri));
		})
	)

	disposables.push(
		genrtlCommandBarService.onDidChangeActiveURI(({ uri }) => {
...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		IgenrtlSettingsService: accessor.get(IgenrtlSettingsService),
		...
		IgenrtlModelService: accessor.get(IgenrtlModelService),
		IWorkspaceContextService: accessor.get(IWorkspaceContextService),

		IgenrtlCommandBarService: accessor.get(IgenrtlCommandBarService),
...
export const useAccessor = () => {
	if (!reactAccessor_) {
		throw new Error(`鈿狅笍 genRTL useAccessor was called before _registerServices!`)
	}
