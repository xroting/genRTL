...
import { isFeatureNameDisabled } from '../../../../../../../workbench/contrib/genrtl-ai/common/genrtlSettingsTypes.js';
...
export const QuickEditChat = ({
	...
	const loadingIcon = <div
		className="@@codicon @@codicon-loading @@codicon-modifier-spin @@codicon-no-default-spin text-genrtl-ai-fg-3"
	/>
	...
	const keybindingString = accessor.get('IKeybindingService').lookupKeybinding(GENRTL_CTRL_K_ACTION_ID)?.getLabel()
