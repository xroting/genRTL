...
// ---------- Register viewpane inside the genRTL container ----------

// const genRTLThemeIcon = Codicon.symbolObject;
// const genRTLViewIcon = registerIcon('genrtl-ai-view-icon', genRTLThemeIcon, localize('voidViewIcon', 'View icon of the genRTL chat view.'));

// called VIEWLET_ID in other places for some reason
export const GENRTL_VIEW_CONTAINER_ID = 'workbench.view.void'
export const GENRTL_VIEW_ID = GENRTL_VIEW_CONTAINER_ID

// Register view container
const viewContainerRegistry = Registry.as<IViewContainersRegistry>(ViewContainerExtensions.ViewContainersRegistry);
const container = viewContainerRegistry.registerViewContainer({
	id: GENRTL_VIEW_CONTAINER_ID,
	title: nls.localize2('voidContainer', 'Chat'), // this is used to say "genRTL AI" (Ctrl + L)
	ctorDescriptor: new SyncDescriptor(ViewPaneContainer, [GENRTL_VIEW_CONTAINER_ID, {
...
// open sidebar
export const GENRTL_OPEN_SIDEBAR_ACTION_ID = 'genrtl-ai.openSidebar'
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: GENRTL_OPEN_SIDEBAR_ACTION_ID,
			title: 'Open genRTL Sidebar',
		})
	}
...
export class SidebarStartContribution implements IWorkbenchContribution {
	...
	constructor(
		...
		this.commandService.executeCommand(GENRTL_OPEN_SIDEBAR_ACTION_ID)
	}
}
