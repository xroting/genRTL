...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in averilog in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open averilog and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
